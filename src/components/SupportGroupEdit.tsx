...
interface SupportGroupEditProps {
  group: any;
  onSuccess: () => void;
  onCancel: () => void;
}

export function SupportGroupEdit({ group, onSuccess, onCancel }: SupportGroupEditProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    team_leader_contact: group.team_leader_contact || "",
