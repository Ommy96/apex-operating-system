...
import { Plus, Search, Calendar, School, Download, FileText, Users, MapPin, Edit, Trash2, Eye } from "lucide-react";
      ...
      {filteredReports?.length === 0 && (
        <div className="text-center py-12">
          <p className="text-muted-foreground">
            {isStaff ? "You have not submitted any school visit reports yet." : "No school visit reports found."}
          </p>
        </div>
      )}
      ...
      <Dialog open={isViewDialogOpen} onOpenChange={setIsViewDialogOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden">
          <DialogHeader className="pb-4 border-b">
            <DialogTitle className="text-xl font-semibold">School Visit Report Details</DialogTitle>
          </DialogHeader>
          {viewingReport && (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-medium text-sm text-muted-foreground">School</span>
                      </div>
                      <p className="text-base font-medium">{viewingReport.school}</p>
                    </div>
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
