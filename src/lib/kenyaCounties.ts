// Kenya Counties and their Sub-Counties
export const KENYA_COUNTIES: Record<string, string[]> = {
  ...
  "Homa Bay": ["Homa Bay Town", "Kabondo Kasipul", "Karachuonyo", "Kasipul", "Mbita", "Ndhiwa", "Rangwe", "Suba North"],
  "Isiolo": ["Garbatulla", "Isiolo North", "Merti"],
  "Kajiado": ["Kajiado Central", "Kajiado East", "Kajiado North", "Kajiado South", "Kajiado West"],
  "Kakamega": ["Butere", "Ikolomani", "Khwisero", "Likuyani", "Lugari", "Lurambi", "Malava", "Matete", "Matungu", "Mumias East", "Mumias West", "Navakholo", "Shinyalu"],
